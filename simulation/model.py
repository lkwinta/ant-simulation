...
from agents import FeromoneAntAgent, RandomAntAgent, FoodSourceAgent, NestAgent, AntAgent
...
class AntsModel(Model):
    def __init__(self, scenario: AntsScenario =None, ant_class: type[AntAgent]=FeromoneAntAgent):
        ...
        self.food_source = FoodSourceAgent(self, self.grid[right_room_center[0], right_room_center[1]], food_amount=1000)
        ...
        (
            self.data_registry.track_model(self, "model_data", ["count_ants_1_short", "count_ants_2_short", "count_ants_1_long", "count_ants_2_long"]).record(
                self.recorder, configuration=DatasetConfig(start_time=4, interval=2)
            )
        )
        ...
        self.datacollector = DataCollector(
            ...
            model_reporters={"Feromone Sum": "feromone_sum",
    ...
    def step(self):
        ...
        self.feromone_layer.data = AntsModel._diffusion(self.feromone_layer.data, self.diffusion_rate, self.wall_layer.data.astype(bool))
